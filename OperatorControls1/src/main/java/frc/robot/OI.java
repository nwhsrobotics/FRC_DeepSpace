...
public class OI {
  ...
  public OI () {
    ...
    xButton.toggleWhenPressed(new CameraToggle);

    rightTrigger.togglewhenActive(new SlideRightToggle);
    rightTrigger.whenInactive(new SlideLeftStop);

    backButton.whenPressed(new Lvl2Descent);
    startButton.whenPressed(new Lvl2Climb);
    playButton.whenPressed(new Lvl3Climb);


    yButton.toggleWhenPressed(new HighHatchInitiate);
    xButton.toggleWhenPressed(new MidHatchInitiate);
    aButton.toggleWhenPressed(new LowHatchInitiate);
    bButton.toggleWhenPressed(new ClampToggle);
