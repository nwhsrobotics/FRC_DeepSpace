...
public class RobotMap {
  ...
  public enum MapKeys {
    ...
    PCM_ARMCANID,
    SOLENOID_PUSHERPUSH, SOLENOID_PUSHERRETRACT, SOLENOID_ARMFORWARD, SOLENOID_ARMREVERSE, FRONTLEFTCLIMBWHEEL, FRONTRIGHTCLIMBWHEEL, CLIMBFRONT, CLIMBBACK
  ...
  public void initDashboardMap() {
    ...
    */
    ...
    airlock.put(MapKeys.CLIMBFRONT, 13);
    airlock.put(MapKeys.CLIMBBACK, 14);
